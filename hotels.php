							...
							<div class="wrap-division">
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=22" class="hotel-img" style="background-image: url(images/hotel-1.jpg);">
										...
										<div class="desc">
											...
											<h3><a href="hotel-room.html">Hotel Cox's Heaven</a></h3>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=21" class="hotel-img" style="background-image: url(images/hotel-2.jpg);">
										...
										<div class="desc">
											...
											<h3><a href="hotel-room.html">Hotel Sea Star</a></h3>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=23" class="hotel-img" style="background-image: url(images/hotel-3.jpg);">
										...
										<div class="desc">
											...
											<h3><a href="hotel-room.html">Hotel Tea Garden</a></h3>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=24" class="hotel-img" style="background-image: url(images/hotel-4.jpg);">
										...
										<div class="desc">
											...
											<h3><a href="hotel-room.html">Hotel Blue Star</a></h3>
											<span class="place">Sylhet</span>
											<p>I am not a great book, I am not a great artist, but I love art and I love food, so I am the perfect traveller.</p>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=25" class="hotel-img" style="background-image: url(images/hotel-5.jpg);">
											<p class="price"><span>2,200TK</span><small> /night</small></p>
										</a>
										<div class="desc">
											...
											<h3><a href="hotel-room.html">Hotel Raddison Blue Water Garden Hotel</a></h3>
											<span class="place">Bandarban</span>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=26" class="hotel-img" style="background-image: url(images/hotel-6.jpg);">
											<p class="price"><span>900TK</span><small> /night</small></p>
										</a>
										<div class="desc">
											...
											<h3><a href="hotel-room.html">Kuakata Grand Hotel and Sea Resort</a></h3>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=27" class="hotel-img" style="background-image: url(images/hotel-7.jpg);">
											<p class="price"><span>1,000TK</span><small> /night</small></p>
										</a>
										<div class="desc">
											...
											<h3><a href="hotel-room.html">Hotel In Bogra</a></h3>
											<span class="place">Rajshahi</span>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="add_to_cart.php?id=28" class="hotel-img" style="background-image: url(images/hotel-8.jpg);">
											<p class="price"><span>620TK</span><small> /night</small></p>
										</a>
										<div class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 245 Reviews</p>
											<h3><a href="hotel-room.html">Hotel Edison</a></h3>
											<span class="place">Khagrachori</span>
									...
									<div class="col-md-12">
						                ...
						                <div class="col-md-6">
						                  <div class="form-group">
						                    ...
						                    <div class="form-field">
						                      <i class="icon icon-arrow-down3"></i>
						                      <select name="peoplef" id="people" class="form-control">
						                        <option value="#">1</option>
						                ...
						                <div class="col-md-6">
						                  <div class="form-group">
						                    ...
						                    <div class="form-field">
						                      <i class="icon icon-arrow-down3"></i>
						                      <select name="peoplet" id="people" class="form-control">
									...
									<div class="col-md-12">
										...
										<form method="post" class="colorlib-form-2">
										   <div class="form-check">
												<input type="checkbox" class="form-check-input" id="exampleCheck1">
												<label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Cox's Bazar</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Saint Martin</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Khagrachori</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Bandarban</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Rajshahi</h4>
												</label>
										   </div>
										</form>
									</div>
