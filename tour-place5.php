												...
												<div class="row">
													...
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															...
															<p>Puthia Rajbari is a palace in Puthia Upazila, in Bangladesh, built in 1895, for Rani Hemanta Kumari, it is an example of Indo-Saracenic Revival architecture. The palace is sited on the Rajshahi Nator highway 30 km from the east of the town and one km south from Rajshahi Nator highway. It is currently used by Lashkarpur Degree College but is in a poor state of repair.</p>
														</div>
													</div>
												</div>
											</div>
					...
					<div class="col-md-3">
						<div class="sidebar-wrap">
							...
							<div class="side animate-box">
								<div class="row">
									<div class="col-md-12">
										<h3 class="sidebar-heading">More places to visit in Puthia</h3>
										<form method="post" class="colorlib-form-2">
										   <div class="form-check">
												<input type="checkbox" class="form-check-input" id="exampleCheck1">
												<label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Pancharatna Gobinda Mandir</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Bara Annik Mandir</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Tarapur Mandir</h4>
												</label>
										   </div>
										</form>
									</div>
