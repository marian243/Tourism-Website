						...
						<div class="row">
							<div class="wrap-division">
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place.php" class="tour-img" style="background-image: url(images/tour-1.jpg);">
                                            <p class="price"><span>5,000TK</span></p>
										</a>
										<span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
											<h2><a href="tour-place.php">Shundarban</a></h2>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place1.php" class="tour-img" style="background-image: url(images/tour-2.jpg);">
                                            <p class="price"><span>6,000TK</span></p>
										</a>
										<span class="desc">
											...
											<h2><a href="tour-place1.php">Srimangal</a></h2>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place2.php" class="tour-img" style="background-image: url(images/tour-3.jpg);">
                                            <p class="price"><span>4,000TK</span></p>
										</a>
										<span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
											<h2><a href="tour-place2.php">Kaptai Lake</a></h2>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place3.php" class="tour-img" style="background-image: url(images/tour-4.jpg);">
                                            <p class="price"><span>5,000TK</span></p>
										</a>
										<span class="desc">
											...
											<h2><a href="tour-place3.php">Saint Martin</a></h2>
											<span class="city">Chittagang</span>
										</span>
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place4.php" class="tour-img" style="background-image: url(images/tour-5.jpg);">
                                            <p class="price"><span>6,000TK</span></p>
										</a>
										<span class="desc">
											...
											<h2><a href="tour-place4.php">Jaflong</a></h2>
											<span class="city">Sylhet</span>
										</span>
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place5.php" class="tour-img" style="background-image: url(images/tour-6.jpg);">
                                            <p class="price"><span>3,000TK</span></p>
										</a>
										<span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
											<h2><a href="tour-place5.php">Puthia Rajbari</a></h2>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place6.php" class="tour-img" style="background-image: url(images/tour-7.jpg);">
                                            <p class="price"><span>4,000TK</span></p>
										</a>
										<span class="desc">
											...
											<h2><a href="tour-place6.php">Family Tour in Cox's Bazar</a></h2>
											<span class="city">CHittagang</span>
										</span>
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">
										<a href="tour-place7.php" class="tour-img" style="background-image: url(images/tour-8.jpg);">
                                            <p class="price"><span>3,000TK</span></p>
										</a>
										<span class="desc">
											...
											<h2><a href="tour-place7.php">Kuakata</a></h2>
					...
					<div class="col-md-3">
						<div class="sidebar-wrap">
							<div class="side search-wrap animate-box">
								...
								<form action="test1.php" method="post" class="colorlib-form">
				              	<div class="row">
				              	 <div class="col-md-12">
				                ...
				                <div class="col-md-12">
				                  <div class="form-group">
				                    ...
				                    <div class="form-field">
				                      <i class="icon icon-calendar2"></i>
				                      <input type="text" id="date1" name="date1" class="form-control date" placeholder="Check-out date">
				                    </div>
				                  </div>
				                </div>
				                <div class="col-md-12">
