...
//    { 
	   if(isset($_POST['submit']) && isset($_POST['peoplef']) && $_POST['peoplet'])
	   {
		...
		//	echo $price_to;
			 ...
			 $sql = "SELECT hotel_name,Hotel_price,room_type,room_status FROM package WHERE Hotel_price BETWEEN '$price_from' 
			 		and '$price_to' ";
...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<form method="POST" action="hotel-room.php">
		<div id="page">
												...
												<div class="room-wrap">
													<div class="row">
														...
														<div class="col-md-6 col-sm-6">
															<div class="desc">
																<h2>Family Room</h2>
																<p class="price"><span>1,200TK</span> <small>/ night</small></p>
																<p>Without travel I would have wound up a little ignorant white Southern female, which was not my idea of a good life.</p>
												...
												<div class="room-wrap">
													<div class="row">
														...
														<div class="col-md-6 col-sm-6">
															<div class="desc">
																<h2>Suite Room</h2>
																<p class="price"><span>600TK</span> <small>/ night</small></p>
																<p>The first condition of understanding a foreign country is to smell it.</p>
																<p><a href="#" class="btn btn-primary">Book Now!</a></p>
															</div>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-6 col-sm-6">
															<div class="desc">
																...
																<p class="price"><span>1,500TK</span> <small>/ night</small></p>
													...
													<div class="row">
														...
														<div class="col-md-6 col-sm-6">
															<div class="desc">
																...
																<p>Never go on trips with anyone you do not love
																	   .</p>
																<p><a href="#" class="btn btn-primary">Book Now!</a></p>
															</div>
														</div>
										...
										<div class="col-md-12">
											...
											<div class="col-md-6">
											  <div class="form-group">
												...
												<div class="form-field">
												  <i class="icon icon-arrow-down3"></i>
												  <select name="peoplef" id="peoplef" class="form-control">
											...
											<div class="col-md-6">
											  <div class="form-group">
												...
												<div class="form-field">
												  <i class="icon icon-arrow-down3"></i>
												  <select name="peoplet" id="peoplet" class="form-control">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<p>
		opyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <i class="icon-heart2" aria-hidden="true"></i> Designed by Shafayat Bin Shabbir Mugdha And Kibtia Chowdhury</a><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
