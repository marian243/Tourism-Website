					...
					<div class="col-md-3">
						<div class="sidebar-wrap">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<form method="post" class="colorlib-form-2">
										   ...
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="hl">
										      <label class="form-check-label" for="exampleCheck1">
							...
							<div class="side animate-box">
								<div class="row">
									<div class="col-md-12">
										<h3 class="sidebar-heading">Things to do in Sundarban</h3>
										<form method="post" class="colorlib-form-2">
										   <div class="form-check">
												<input type="checkbox" class="form-check-input" id="exampleCheck1">
												<label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Sundarban National Park</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Boat ride on the narrow canal</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Walk inside the forest</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Jamtola beach</h4>
												</label>
										   </div>
										   <div class="form-check">
										      <input type="checkbox" class="form-check-input" id="exampleCheck1">
										      <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Wild life Sanctuary</h4>
												</label>
										   </div>
										</form>
									</div>
