...
//echo "page";
	...
	if (isset($_POST['submit']))
    {
        //echo "page";
        $myname = $_POST["id"];
        $myuseranme = $_POST["name"];
        $mypassword= $_POST["password"];
        $sql = "INSERT INTO userlogin (email,name, pass) VALUES ('$myname','$myusername','$mypassword')";
      //mysqli_query($db,$sql);
        connect('bdtouristation',$sql);
								...
								<div class="wrap-division">
									<div class="col-md-12 col-md-offset-0 heading2 animate-box">
                                        ...
                                        <div style = "margin:30px">
                                          ...
                                          <label>EmailID  :</label><input type = "text" name = "id" class = "box"/><br /><br />
